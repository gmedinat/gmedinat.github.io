...
<div style="display: flex; align-items: center;">
    ...
    <img src="Figures/galacticMap2_dark_bg_transp.png" alt="Galactic Map" style="width: 300px; margin-right: 15px;">
    <p>
...
<div style="display: flex; align-items: center;">
    ...
    <img src="Figures/haloprof_allsky_mod_All_AllRRL_Rel_sinCorr_Mask_dark.png" alt="Halo Profile" style="width: 300px; margin-left: 15px;">
</div>

<div style="display: flex; align-items: center;">
    <!-- Image on the left of text -->
    <img src="Figures/two_plots_shades_95_all_noSex_Rgc_Mask_sinCorr.png" alt="Data Plots" style="width: 300px; margin-right: 15px;">
    <p>
